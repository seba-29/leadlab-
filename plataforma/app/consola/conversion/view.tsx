...
// Vista de Conversión — embebible como tab del Dashboard (admin) y como
// página propia (alias). No renderiza <h1>: el título lo pone el contenedor.
...
export function fmtSeg(s: number | null): string {
  if (s == null) return "—";
  if (s < 60) return `${s} s`;
    ...
    <div>
      {isAdmin && (
        <div className="cerebro-bar">
          <span className="cerebro-bar-label">Ver</span>
