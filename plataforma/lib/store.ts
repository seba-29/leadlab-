...
export const guardarLogo = impl.guardarLogo;
export const quitarLogo = impl.quitarLogo;
export const listMiembros = impl.listMiembros;
export const crearMiembro = impl.crearMiembro;
export const eliminarMiembro = impl.eliminarMiembro;
